#!/bin/bash
#
# This script automatically bumps the version of Argent
# ebuilds.
...
VERSION="${1}"
OVERLAY_BASE_URL="git@github.com:Argent"
OVERLAY_BASE_DIR="${ARGENT_MOLECULE_HOME:-${HOME}}"

PACKAGES=(
    "app-misc/argent-version argent-distro"
)
