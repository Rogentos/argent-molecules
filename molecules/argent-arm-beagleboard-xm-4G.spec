...
%env %import ${ARGENT_MOLECULE_HOME:-/argent}/molecules/beagleboard-xm.common
...
# produced otherwise)
%env image_name: Argent_Linux_${ARGENT_RELEASE:-11}_armv7l_BeagleBoard_xM_4GB.img
...
%env source_boot_directory: ${ARGENT_MOLECULE_HOME:-/argent}/boot/arm/beagleboard

# External script that will generate the image file.
# The same can be copied onto a MMC by using dd
%env image_generator_script: ${ARGENT_MOLECULE_HOME:-/argent}/scripts/beagleboard_image_generator_script.sh omap3-beagle-xm.dtb
