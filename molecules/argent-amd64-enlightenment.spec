...
%env %import ${ARGENT_MOLECULE_HOME:-/argent}/molecules/enlightenment.common
...
%env destination_iso_image_name: Argent_Linux_${ARGENT_RELEASE:-11}_amd64_Enlightenment.iso
