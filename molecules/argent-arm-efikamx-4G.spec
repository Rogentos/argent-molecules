...
%env %import ${ARGENT_MOLECULE_HOME:-/argent}/molecules/efikamx-base.common
...
# produced otherwise)
%env image_name: Argent_Linux_${ARGENT_RELEASE:-11}_armv7l_EfikaMX_Base_4GB.img
...
%env source_boot_directory: ${ARGENT_MOLECULE_HOME:-/argent}/boot/arm/efikamx

# External script that will generate the image file.
# The same can be copied onto a MMC by using dd
%env image_generator_script: ${ARGENT_MOLECULE_HOME:-/argent}/scripts/efikamx_image_generator_script.sh
