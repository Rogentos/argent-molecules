...
%env %import ${ARGENT_MOLECULE_HOME:-/argent}/molecules/beagleboard.common
...
# produced otherwise)
%env image_name: Argent_Linux_${ARGENT_RELEASE:-11}_armv7l_BeagleBoard_4GB.img
...
%env image_generator_script: ${ARGENT_MOLECULE_HOME:-/argent}/scripts/beagleboard_image_generator_script.sh omap3-beagle.dtb
